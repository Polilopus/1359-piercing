...
const reviewsData = [
    ...
    },
    {
        ...
        {
        rating: 5,
        text: "Лилия просто чудесный мастер! Я пришёл на перепрокол септума после неудачного первого прокола у другого мастера и, честно говоря, немного переживал, что с моими особенностями анатомии снова что-то пойдёт не так. Но здесь всё прошло просто прекрасно. Мастерица очень внимательно осмотрела, всё подробно объяснила, аккуратно и спокойно выполнила работу, абсолютно безболезненно. В итоге прокол получился ровным, красивым и именно таким, каким я хотел его видеть 😊 Особенно приятно было почувствовать внимательное и профессиональное отношение после предыдущего неудачного опыта. Спасибо большое за аккуратность, заботу и отличный результат 😊",
        author: "Клиент (перепрокол септума)",
        date: "2026"
    }
];
